...
ws.onopen = function(){
	...
	var batimentSend = {"pageWeb" : "deleteBatiment", "type" : "appelBdd"};
...
function batiment_js(){
		...
		document.getElementById('id_batiment_js').innerHTML = '<label for = "batiments">Nom du batiment : </label><select name = "batiments" id ="batiments"/>' + addBatiment() + '</select>';
}
...
function sendDeleteBatiment(){

var batiments = document.getElementById("batiments");
batiments = batiments.value;

var myJSONObject = { "pageWeb" : "deleteBatiment", "type" : "modifBdd", "tableau" :[batiments]};
