...
ws.onopen = function(){
	...
	var batimentSend = {"pageWeb" : "etudiant", "type" : "pasFait"};
...
function etudiant_js(){
		...
		document.getElementById('id_etudiant_js').innerHTML = '<label for = "etudiants">Nom et prénom de l étudiant : </label><select name = "etudiants" id ="etudiants"/>' + addEtudiant() + '</select><input type = "button" value ="Valider" onClick = "envoieNom()"/>';
}
...
var requeteSend2 = {"pageWeb" : "etudiant", "type" : "fait", "tableau" : [nom,prenom]};
