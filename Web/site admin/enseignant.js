...
ws.onopen = function(){
	...
	var batimentSend = {"pageWeb" : "enseignant", "type" : "pasFait"};
...
function etudiant_js(){
		...
		document.getElementById('id_etudiant_js').innerHTML = '<label for = "etudiants">Nom et prénom de l enseignant : </label><select name = "etudiants" id ="etudiants"/>' + addEtudiant() + '</select><input type = "button" value ="Valider" onClick = "envoieNom()"/>';
}
...
var requeteSend2 = {"pageWeb" : "enseignant", "type" : "fait", "tableau" : [nom,prenom]};
